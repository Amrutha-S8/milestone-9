...
from sqlalchemy import create_engine, Column, Integer, String, Float, Text, DateTime, JSON, MetaData, Table
...
class PostgresStorage:
    ...
    def get_latest_evaluation_report(self) -> Optional[dict]:
        with self.session() as session:
    ...
    def get_latency_statistics(self, language: Optional[str] = None) -> dict:
        with self.session() as session:
