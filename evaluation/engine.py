...
class EvaluationEngine:
    ...
    def _generate_summary(self, accuracy_results, _wer_results, _completion_results, _scores, status_results) -> dict[str, Any]:
    ...
    def get_language_status(self, language: str) -> dict[str, Any] | None:
