...
class LanguageRegistry:
    ...
    def get_flow(self, language_identifier: str) -> Optional[BaseLanguageFlow]:
    ...
    def detect_and_process(self, text: str, target_language: Optional[str] = None, current_state: Optional[str] = None) -> FlowResult:
        """
        ...
        best_flow: Optional[BaseLanguageFlow] = None
